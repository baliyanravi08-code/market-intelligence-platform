...
export class NSEClient {
    ...
    static maxpain(optionChain, expiryDate) { return OptionsApi.calculateMaxPain(optionChain, expiryDate); }
    ...
    async optionChainV3(params) {
        return this.options.getOptionChainV3(params);
    }
    async getExpiryDatesV3(symbol) { return this.options.getExpiryDatesV3(symbol); }
    async filteredOptionChainV3(symbol, expiry, strikeRange) {
    ...
    static maxpainV3(optionChain, expiry) { return OptionsApi.calculateMaxPainV3(optionChain, expiry); }
